...
ALTER TABLE "plans" ADD COLUMN IF NOT EXISTS "planKey" TEXT;
ALTER TABLE "plans" ADD COLUMN IF NOT EXISTS "currency" TEXT NOT NULL DEFAULT 'NGN';
CREATE UNIQUE INDEX IF NOT EXISTS "plans_planKey_key" ON "plans"("planKey");

-- Add missing columns to transactions
ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "classification" TEXT NOT NULL DEFAULT 'unknown';
ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "categoryConfidence" DECIMAL(5,4);
...
ALTER TABLE "subscriptions" ADD COLUMN IF NOT EXISTS "providerSubscriptionId" TEXT;
...
ALTER TABLE "import_batches" ADD COLUMN IF NOT EXISTS "source" TEXT NOT NULL DEFAULT 'statement';
